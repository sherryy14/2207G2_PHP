<?php 
$connection_db = mysqli_connect('localhost','root','','courier');
...
if(isset($_POST['add_agent'])){
  ...
  $checkResult = mysqli_query($connection_db, $check);
      ...
      <div class="col-lg-6">
         <div class="card">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" name="pass" id="input-4" placeholder="Enter Password" >
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
            <button type="submit" name="add_agent" class="btn btn-light px-5"><i class="icon-lock"></i> Save Agent</button>
          </div>
          </form>
         </div>
         </div>
